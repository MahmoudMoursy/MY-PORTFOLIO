...
export default function Resume() {
  ...
  const education = [
    {
      year: '2024',
      title: 'frontend  and cross-platform mobile applications',
      institution: 'ITI',
      description: "I craft responsive frontend websites and cross-platform mobile applications with clean UI and smooth user experience.",
    },
    {
      year: '2024',
      title: 'Software Development fundamentals',
      institution: 'ITI',
      description: "Understanding core programming concepts, problem-solving techniques, and the basics of building reliable software systems.",
    },
    {
      year: '2018 - 2022',
