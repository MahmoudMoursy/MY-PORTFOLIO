...
const services = [
  {
    ...
    description: 'Cross-platform mobile applications using Flutter Or React Native',
  },
  {
    icon: <Globe className="w-12 h-12" />,
    title: 'Web Development',
    description: 'Responsive websites using React.js,Next, HTML, CSS, and JavaScript',
  },
  {
